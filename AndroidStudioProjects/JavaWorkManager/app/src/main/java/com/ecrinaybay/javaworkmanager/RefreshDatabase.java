package com.ecrinaybay.javaworkmanager;
...
public class RefreshDatabase extends Worker {
    ...
    private void refreshDatabase(int myNumber){
        SharedPreferences sharedPreferences = myContext.getSharedPreferences("com.ecrinaybay.javaworkmanager",Context.MODE_PRIVATE);
