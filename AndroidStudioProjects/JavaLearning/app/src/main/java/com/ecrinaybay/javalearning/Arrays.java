...
public class Arrays {
    public static void main(String[] args){
        ...
        myIntegerArray[2] = 70;
        myIntegerArray[3] = 80;
        //myIntegerArray[4] = 90; --> ArrayIndexOutBoundsException hatası alırız.
        ...
        myMusicians.add(1,"Kirk"); //1. indexe Kirk'u ekledik.
        myMusicians.add("Rob");
        ...
        // Set
        //Dizi ve list gibi ama bir eleman sadece içerisinde 1 defa yer alabiliyor.
        ...
        System.out.println(mySet.size()); //cvp:1
